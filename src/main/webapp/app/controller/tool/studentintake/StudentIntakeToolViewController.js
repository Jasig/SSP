...
Ext.define('Ssp.controller.tool.studentintake.StudentIntakeToolViewController', {
    	...
    	var items = [ Ext.createWidget('tabpanel', {
	        ...
	        items: [ { title: me.textStore.getValueByCode('intake.tab1.label', 'Person')+Ssp.util.Constants.REQUIRED_ASTERISK_DISPLAY,
	        		   ...
	        		   items: [{xtype: 'studentintakepersonal'}]
	            		...
	            		title: me.textStore.getValueByCode('intake.tab2.label', 'Demographics'),
	            		autoScroll: true,
	            		items: [{xtype: 'studentintakedemographics'}]
	        		},{
	            		title: me.textStore.getValueByCode('intake.tab3.label', 'EduPlan'),
	            		autoScroll: true,
	            		items: [{xtype: 'studentintakeeducationplans'}]
	        		},{
	            		title: me.textStore.getValueByCode('intake.tab4.label', 'EduLevel'),
	            		autoScroll: true,
	            		items: [{xtype: 'studentintakeeducationlevels'}]
	        		},{
	            		title: me.textStore.getValueByCode('intake.tab5.label', 'EduGoal'),
	            		autoScroll: true,
	            		items: [{xtype: 'studentintakeeducationgoals'}]
	        		},{
	            		title: me.textStore.getValueByCode('intake.tab6.label', 'Funding'),
	            		autoScroll: true,
	            		items: [{xtype: 'studentintakefunding'}]
	        		},{
	            		title: me.textStore.getValueByCode('intake.tab7.label', 'Challenges'),
	            		autoScroll: true,
	            		hidden: !me.authenticatedPerson.hasAccess('STUDENT_INTAKE_CHALLENGE_TAB'),
	            		items: [{xtype: 'studentintakechallenges'}]
	        		},{
	            		title: me.textStore.getValueByCode('intake.tab8.label', 'Completed Items'),
	            		autoScroll: true,
	...
	buildStudentIntake: function( formData ){
		...
		educationGoalsAdditionalFieldsMap = [
		     {
			  ...
			  parentName: "bachelor",
			  name: "description", 
			  label:  me.textStore.getValueByCode('intake.tab5.label.bachelor-major', "Bachelor's Degree Major"),
			 ...
			 },
		     {
				  ...
				  parentName: "military",
				  name: "description", 
				  label: me.textStore.getValueByCode('intake.tab5.label.military-goal', 'Describe military goal'),
				  fieldType: "mappedtextfield",
				  labelWidth: 200
			 },
			 {
			  ...
			  parentName: "other",
			  name: "description", 
			  label: me.textStore.getValueByCode('intake.tab5.label.other-goal', 'Other Goal'),
			  fieldType: "mappedtextfield",
			  labelWidth: 200
			 }
		];
		...
		educationLevelsAdditionalFieldsMap = [{parentId: Ssp.util.Constants.EDUCATION_LEVEL_NO_DIPLOMA_GED_ID, 
			                                   ...
			                                   label: me.textStore.getValueByCode('intake.tab4.label.last-year-attended', 'Last Year Attended'),
			                                   fieldType: "mappedtextfield", 
		                                      ...
		                                      {parentId: Ssp.util.Constants.EDUCATION_LEVEL_NO_DIPLOMA_GED_ID, 
			                                   ...
			                                   label: me.textStore.getValueByCode('intake.tab4.label.highest-grade', 'Highest Grade Completed'),
			                                   enforceMaxLength: true,
			                                   maxLength: 10,
			                                   fieldType: "mappedtextfield", 
			                                   labelWidth: defaultLabelWidth},
		                                      {parentId: Ssp.util.Constants.EDUCATION_LEVEL_GED_ID, 
			                                   parentName: "ged", 
			                                   name: "graduatedYear", 
			                                   label: me.textStore.getValueByCode('intake.tab4.label.year-of-ged', 'Year of GED'),
			                                   enforceMaxLength: true,
			                                   maxLength: 20,			                                   
			                                   fieldType: "mappedtextfield",
			                                   labelWidth: defaultLabelWidth,
		                                      ...
		                                      {parentId: Ssp.util.Constants.EDUCATION_LEVEL_HIGH_SCHOOL_GRADUATION_ID, 
			                                   ...
			                                   name: "graduatedYear", 
			                                   label: me.textStore.getValueByCode('intake.tab4.label.year-graduated', 'Year Graduated'),
			                                   fieldType: "mappedtextfield",
			                                   labelWidth: defaultLabelWidth,
			                                   enforceMaxLength: true,
			                                   maxLength: 20,			                                   
			                                 ...
			                                 parentName: "high school graduation", 
			                                 name: "schoolName", 
			                                 label: me.textStore.getValueByCode('intake.tab4.label.highschool-attended', 'High School Attended'),
			                                 fieldType: "mappedtextfield",
			                                 maxLength: 255,
			                                 labelWidth: defaultLabelWidth},
			                                 ...
			                                 parentName: "other", 
			                                 name: "description", 
			                                 label: me.textStore.getValueByCode('intake.tab4.label.explain-credits', 'Please Explain'),
		...
		educationLevelFormProps = {
                ...
                fieldSetTitle: me.textStore.getValueByCode('intake.tab4.label.edu-level', 'Education level completed: Select all that apply'),
		...
		fundingSourcesAdditionalFieldsMap = [{parentId: Ssp.util.Constants.FUNDING_SOURCE_OTHER_ID, 
											  parentName: "other",
											  name: "description", 
											  label: me.textStore.getValueByCode('intake.tab6.label.other-funding', 'Other'),
											  fieldType: "mappedtextarea",
											  labelWidth: defaultLabelWidth}];
		...
		fundingSourceFormProps = {
                ...
                fieldSetTitle: me.textStore.getValueByCode('intake.tab6.label.funding-question', 'How will you pay for college?'),
		...
		challengesAdditionalFieldsMap = [{parentId: Ssp.util.Constants.CHALLENGE_OTHER_ID,
			                              parentName: "other",
			                              name: "description", 
			                              label: me.textStore.getValueByCode('intake.tab6.label.other-challenges', 'Other'),
			                              fieldType: "mappedtextarea",
			                              labelWidth: defaultLabelWidth}];
		...
		challengeFormProps = {
                ...
                fieldSetTitle: me.textStore.getValueByCode('intake.tab7.label.challenges-question', 'Select all challenges that may be barriers to your academic success'),
                itemsArr: challenges, 
		...
		checklistFormProps = {
                ...
                fieldSetTitle: me.textStore.getValueByCode('intake.tab8.label.checklist-question', 'Check all that apply'),
                itemsArr: checklist, 
