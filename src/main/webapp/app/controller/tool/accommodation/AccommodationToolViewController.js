...
Ext.define('Ssp.controller.tool.accommodation.AccommodationToolViewController', {
	...
	buildAccommodation: function( formData ){
		...
		disabilityAgencyFormProps = {
                ...
                fieldSetTitle: me.textStore.getValueByCode('ssp.label.accommodation.disability-agencies','Select all agencies that apply'),
		...
		fieldSetTitle: me.textStore.getValueByCode('ssp.label.accommodation.disability-types','Select all that apply'),
		...
		disabilityAccommodationsFormProps = {
			...
			fieldSetTitle: me.textStore.getValueByCode('ssp.label.accommodation.disability-accommodations','Select all that apply'),
