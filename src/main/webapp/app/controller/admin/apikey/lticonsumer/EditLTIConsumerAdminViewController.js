 ...
 * under the License.
 */
Ext.define('Ssp.controller.admin.apikey.lticonsumer.EditLTIConsumerAdminViewController', {
    ...
    config: {
        ...
        formToDisplay: 'lticonsumeradmin'
    },
    control: {
        'saveButton': {
            click: 'onSaveClick'
    ...
    initViewForCreate: function() {
        var me = this;
        me.getView().client = Ext.create('Ssp.model.LTIConsumer');
        me.getView().getForm().loadRecord(me.getView().client);
    },
    ...
    persistForm: function() {
        ...
        var baseUrl = me.apiProperties.createUrl( me.apiProperties.getItemUrl('ltiConsumer') );
    ...
    bindFormToModel: function() {
        ...
        } else if ( me.getSecret().getValue().length > 0) {
            record.set('secretChange', true);
        }
