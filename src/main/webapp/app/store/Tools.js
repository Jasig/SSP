...
Ext.define('Ssp.store.Tools', {
    ...
    constructor: function(){
        ...
        var sspTools = [{ group:'beta', name: "Main", toolType: "profile", active: true },
            ...
            { group:'rc1', name: "", toolType: "", active: false },
            { group:'rc1', name: "Legacy Remarks", toolType: "", active: true },
			{ group:'rc1', name: "Documents", toolType: "", active: true },
            { group:'rc1', name: "----------------", toolType: "", active: false },
            { group:'rc1', name: "Config Link", toolType: "", active: false },
            { group:'rc1', name: "Program Viewer", toolType: "", active: false },
            { group:'rc1', name: "MAP Help", toolType: "", active: false }
