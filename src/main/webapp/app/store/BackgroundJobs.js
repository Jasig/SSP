    ...
    load: function() {
        ...
        var data = [
            { name:'sendmessages', displayName: 'send_messages',
                ...
                defaultTime: 'Every 2.5 minutes', configName: 'task_send_messages_trigger', running: '', executable: 'true'},
            { name:'synccoaches', displayName: 'sync_coaches',
                ...
                defaultTime: 'Every 5 minutes', configName: 'task_sync-coaches_trigger', running: '', executable: 'true'},
            { name:'processcaseloadbulkadd', displayName: 'process_caseload_bulk_add_reassignment',
                description: 'Processes and executes queued Bulk Actions from Caseload.',
                defaultTime: 'Every 15 minutes', configName: 'task_sync-caseload-bulk-add_trigger', running: '', executable: 'true'},
            ...
            { name:'sendtaskreminders', displayName: 'send_task_reminders',
                ...
                defaultTime: 'Nightly at 2 a.m.', configName: 'task_send_task_indicators_trigger', running: '', executable: 'true'},
