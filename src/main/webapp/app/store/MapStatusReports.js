 ...
 * under the License.
 */
Ext.define('Ssp.store.MapStatusReports', {
    extend: 'Ext.data.Store',
    model: 'Ssp.model.tool.map.MapStatus',
	...
	constructor: function(){
		Ext.apply(this, {
							proxy: this.apiProperties.getProxy(this.apiProperties.getItemUrl('mapStatusReport')),
							autoLoad: false
						});
