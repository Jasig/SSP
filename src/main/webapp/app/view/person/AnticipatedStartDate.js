	...
	initComponent: function() {
		...
		Ext.apply(this, 
			...
			items: [
			{
		        ...
		        emptyText: me.textStore.getValueByCode('ssp.empty-text.edit-person.anticipated-start-term','Select One'),
		        ...
		        emptyText: me.textStore.getValueByCode('ssp.empty-text.edit-person.anticipated-start-year','Select One'),
