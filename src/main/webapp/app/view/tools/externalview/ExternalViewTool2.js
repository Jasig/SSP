 ...
 * under the License.
 */
Ext.define('Ssp.view.tools.externalview.ExternalViewTool2', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.externalviewtool2',
    ...
    initComponent: function() {
        ...
        if (me.externalViewService) {
            me.setLoading(true);
            me.externalViewService.getExternalViewWithSubstitutedUrl('22cdbc52-e771-4e37-acdd-8f0a3a587b6c',
                me.person.get('id'), {
