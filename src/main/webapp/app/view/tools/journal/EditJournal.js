            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        emptyText: me.textStore.getValueByCode('ssp.empty-text.journal.confidentiality-level','Select One'),
                        ...
                        emptyText: me.textStore.getValueByCode('ssp.empty-text.journal.source','Select One'),
