 ...
 * under the License.
 */
Ext.define('Ssp.view.tools.profile.RiskIndicators', {
    extend: 'Ext.view.View',
    alias: 'widget.profileriskindicators',
    mixins: ['Deft.mixin.Injectable', 'Deft.mixin.Controllable'],
    // controller: 'Ssp.controller.tool.profile.ProfileRiskIndicatorsViewController',
    // inject: {
    ...
    initComponent: function(){
        ...
        Ext.define('Risk', {
            ...
            fields: [{
                ...
                name: 'indicatorValueDescription',
                type: 'string'
            }, {
        ...
        Ext.apply(me, {
            layout: 'column',
            margin: 0,
            store: Ext.data.StoreManager.lookup('risksStore'),
            hideHeaders: true,
            deferInitialRefresh: false,
            tpl: tpl,
            itemSelector: 'div.indicator-wrap',
            emptyText: 'No risk indicators',
            autoScroll: true,
            flex: 1,
			maxHeight: 240
        });
