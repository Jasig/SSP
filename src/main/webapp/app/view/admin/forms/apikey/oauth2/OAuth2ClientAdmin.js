 ...
 * under the License.
 */
Ext.define('Ssp.view.admin.forms.apikey.oauth2.OAuth2ClientAdmin', {
    extend: 'Ext.grid.Panel',
    alias : 'widget.oauth2clientadmin',
    title: 'OAuth2 Client Admin',
    mixins: [ 'Deft.mixin.Injectable',
        'Deft.mixin.Controllable'],
    controller: 'Ssp.controller.admin.apikey.oauth2.OAuth2ClientAdminViewController',
    inject: {
