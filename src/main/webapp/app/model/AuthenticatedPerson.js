...
Ext.define('Ssp.model.AuthenticatedPerson', {
    ...
    statics: {
    	...
    	/* BULK ACTION */
    	REQUIRED_ANY_PERMISSIONS_EXPORT_TO_CSV: ['ROLE_PERSON_CASELOAD_READ','ROLE_BULK_SEARCH_EXPORT'],
    	REQUIRED_ANY_PERMISSIONS_BULK_EMAIL: ['ROLE_PERSON_WRITE','ROLE_BULK_EMAIL_STUDENT'],
    	...
    	REQUIRED_ANY_PERMISSIONS_EMAIL_STUDENT_BUTTON: ['ROLE_PERSON_WRITE','ROLE_PERSON_FILTERED_WRITE'],
