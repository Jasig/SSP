...
Ext.define('Ssp.model.AuthenticatedPerson', {
    ...
    statics: {
		...
		REQUIRED_PERMISSIONS_ADD_STRENGTH_BUTTON: ['ROLE_PERSON_GOAL_WRITE'],
    	REQUIRED_PERMISSIONS_EDIT_STRENGTH_BUTTON: ['ROLE_PERSON_GOAL_WRITE'],
    	REQUIRED_PERMISSIONS_DELETE_STRENGTH_BUTTON: ['ROLE_PERSON_GOAL_DELETE'],
