...
Ext.define('Ssp.model.AuthenticatedPerson', {
    ...
    statics: {
		...
		REQUIRED_PERMISSIONS_MAP_TOOL_PUBLIC_TEMPLATE_WRITE:['ROLE_REFERENCE_WRITE'],
		
		
		/* LEGACY REMARK TOOL */
		REQUIRED_PERMISSIONS_PERSONNOTES_TOOL:['ROLE_PERSON_READ'],//ROLE_PERSON_LEGACY_REMARK_READ
