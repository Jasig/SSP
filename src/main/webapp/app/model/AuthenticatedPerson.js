Ext.define('Ssp.model.AuthenticatedPerson', {
    ...
    statics: {
    	...
    	REQUIRED_PERMISSIONS_STUDENT_INTAKE_PRINT_CONFIDENTIALITY_AGREEMENT_BUTTON: ['REFERENCE_READ'],
    	...
    	/* EARLY ALERT TOOL */
    	REQUIRED_PERMISSIONS_EARLYALERT_TOOL:['ROLE_EARLY_ALERT_READ','ROLE_EARLY_ALERT_RESPONSE_READ',],
