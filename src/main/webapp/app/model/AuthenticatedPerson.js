Ext.define('Ssp.model.AuthenticatedPerson', {
    ...
    statics: {
    	...
    	REQUIRED_PERMISSIONS_TRANSITION_STUDENT_BUTTON: ['ROLE_PERSON_PROGRAM_STATUS_WRITE'],
    	REQUIRED_PERMISSIONS_SET_NON_PARTICIPATING_BUTTON: ['ROLE_PERSON_PROGRAM_STATUS_WRITE'],
    	REQUIRED_PERMISSIONS_SET_NO_SHOW_BUTTON: ['ROLE_PERSON_PROGRAM_STATUS_WRITE'],
