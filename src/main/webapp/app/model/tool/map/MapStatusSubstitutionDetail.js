 ...
 * under the License.
 */
Ext.define('Ssp.model.tool.map.MapStatusSubstitutionDetail', {
    extend: 'Ssp.model.AbstractBase',
    fields: [{name:'termCode',type:'string'},
            {name:'formattedCourse',type:'string'},
            {name:'courseCode',type:'string'},
            {name:'substitutedTermCode',type:'string'},
            {name:'substitutedFormattedCourse',type:'string'},
            {name:'substitutedCourseCode',type:'string'},
            {name:'substitutionCode',type:'string'},            
            {name:'substitutionNote',type:'string'}            
	],
