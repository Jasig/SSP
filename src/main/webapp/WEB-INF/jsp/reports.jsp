...
<div id="${n}reportSelector" class="fl-widget portlet report" role="section">
    ...
    <div class="fl-widget-titlebar titlebar portlet-titlebar" role="sectionhead">
        ...
        <div class="fl-col">
            ...
            <select class="reports-select"></select>
        </div>
        <div class="fl-col fl-text-align-right">&nbsp;</div></div>
	...
	<div class="reports-form-body"> 
        ...
        <div class="hideable-form counseling-reference-guide" style="display:none">
            ...
            <form action="/ssp/api/1/report/counselingreference" method="get" class="alert-form">
                ...
                <div class="ea-buttons">
                    <div class="buttons">
                        <input class="button primary button-send" type="submit" value="Download" />
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="hideable-form early-alert-case-counts-report" style="display:none">
        ...
        <div class="hideable-form early-alert-student-referral-report" style="display:none">
            ...
            <form action="/ssp/api/1/report/earlyalertstudentreferral" method="get"
                ...
                <!-- Referral Source -->
                <div class="ea-input">
                    <select class='input-early-alert-referral-group' id="earlyAlertStudentReferralEarlyAlertReferralId"
                        name="earlyAlertReferralId"></select>
                </div>
                <div class="ea-label">
                ...
                <div class="ea-time-span">
                    <div class="ea-date-range">
                        <!-- Response Date From -->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="responseCreateDateFrom" id="earlyAlertStudentReferralResponseCreateDateFrom">
                        </div>
                        <div class="ea-label">
                            <span>Start Date (inclusive)::</span>
                        </div>
                        ...
                        <!-- Response Date To -->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="responseCreateDateTo" id="earlyAlertStudentReferralResponseCreateDateTo">
                        </div>
                        <div class="ea-label">
                            <span>End Date (exclusive)::</span>
                        </div>
                ...
                <!-- Date Range Selection on EarlyAlert -->
                <div class="ea-time-span">
                    <div class="ea-term">
                        <div class="ea-input">
                            <select id="earlyAlertStudentReferralTermCode" name="alertTermCode" class="input-term-group">
                               <option value="">${not_applicable}</option>
                            </select>
                        </div>
                        <div class="ea-label">
                    ...
                    <div class="ea-date-range">
                        <!-- Date From EarlyAlert -->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="alertCreateDateFrom" id="earlyAlertStudentReferralAlertCreateDateFrom">
                        </div>
                        <div class="ea-label">
                            <span>Start Date (inclusive)::</span>
                        </div>
                        ...
                        <!-- Date To EarlyAlert -->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="alertCreateDateTo" id="earlyAlertStudentReferralAlertCreateDateTo">
                        </div>
                        <div class="ea-label">
                            <span>End Date (exclusive)::</span>
                        </div>
        ...
        <div class="hideable-form early-alert-student-progress-report" style="display:none">
            ...
            <form action="/ssp/api/1/report/earlyalertstudentprogress" method="get"
                ...
                <!-- Initial Semester -->
                <div class="ea-input">
                    <select id="earlyAlertStudentProgressTermCodeInitial" name="termCodeInitial"
                        class="input-term-group"></select>
                </div>
                <div class="ea-label">
                ...
                <!-- Initial Semester -->
                <div class="ea-input">
                    <select id="earlyAlertStudentProgressTermCodeComparitor" name="termCodeComparitor"
                        class="input-term-group"></select>
                </div>
                <div class="ea-label">
            ...
            <form action="/ssp/api/1/report/earlyalertstudentoutcomeoutreach" method="get"
                ...
                <div class="ea-time-span">
                    <div class="ea-date-range">
                        <!-- Date From Response -->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="responseCreateDateFrom" id="earlyAlertStudentOutreachResponseCreateDateFrom">
                        </div>
                        <div class="ea-label">
                            <span>Start Date (inclusive)::</span>
                        </div>
                        ...
                        <!-- Date To Response-->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="responseCreateDateTo" id="earlyAlertStudentOutreachResponseCreateDateTo">
                        </div>
                        <div class="ea-label">
                            <span>End Date (exclusive)::</span>
                        </div>
                ...
                <div class="ea-clear"></div>
                    ...
                    <div class="ea-term">
                        <div class="ea-input">
                            <select id="earlyAlertStudentOutreachTermCode" name="alertTermCode" class="input-term-group">
                                <option value="">${not_applicable}</option>
                                </select>
                        </div>
                        <div class="ea-label">
                    ...
                    <div class="ea-date-range">
                        <!-- Date From EarlyAlert -->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="alertCreateDateFrom" id="earlyAlertStudentOutreachAlertCreateDateFrom">
                        </div>
                        <div class="ea-label">
                            <span>Start Date (inclusive)::</span>
                        </div>
                        ...
                        <!-- Date To EarlyAlert -->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="alertCreateDateTo" id="earlyAlertStudentOutreachAlertCreateDateTo">
                        </div>
                        <div class="ea-label">
                            <span>End Date (exclusive)::</span>
                        </div>
            ...
            <form action="/ssp/api/1/report/earlyalertstudentoutcomeoutreach" method="get"
                ...
                <div class="ea-time-span">
                    <div class="ea-date-range">
                        <!-- Date From Response-->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="responseCreateDateFrom" id="earlyAlertStudentOutcomeResponseCreateDateFrom">
                        </div>
                        <div class="ea-label">
                            <span>Start Date (inclusive)::</span>
                        </div>
                        ...
                        <!-- Date To Response -->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="responseCreateDateTo" id="earlyAlertStudentOutcomeResponseCreateDateTo">
                        </div>
                        <div class="ea-label">
                            <span>End Date (exclusive)::</span>
                        </div>
                ...
                <div class="ea-clear"></div>
                    ...
                    <div class="ea-time-span">
                        <div class="ea-term">
                            <div class="ea-input">
                                <select id="earlyAlertStudentOutcomeTermCode" name="alertTermCode" class="input-term-group">
                                    <option value="">${not_applicable}</option>
                                </select>
                            </div>
                            <div class="ea-label">
                        ...
                        <!-- Date From EarlyAlert -->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="alertCreateDateFrom" id="earlyAlertStudentOutcomeAlertCreateDateFrom">
                        </div>
                        <div class="ea-label">
                            <span>Start Date (inclusive)::</span>
                        </div>
                        ...
                        <!-- Date To EarlyAlert -->
                        <div class="ea-input">
                            <input class="input-calendar-type" type="textbox" name="alertCreateDateTo" id="earlyAlertStudentOutcomeAlertCreateDateTo">
                        </div>
                        <div class="ea-label">
                            <span>End Date (exclusive)::</span>
                        </div>
        ...
        <div class="hideable-form early-alert-class-report" style="display:none">
            ...
            <form action="/ssp/api/1/report/earlyalertclass" method="get"
                ...
                <!-- Term -->
                <div class="ea-input">
                    <select id="earlyAlertClassTermCode" name="termCode" class="input-term-group"></select>
                </div>
                <div class="ea-label">
                    <span>Term:</span>
                </div>
        ...
        <div class="hideable-form disability-services-report" style="display:none">
            ...
            <form action="/ssp/api/1/report/disabilityservices/" method="get"
                ...
                <div class="ea-input">
                    <label><span>pdf</span></label><input type="radio" name="reportType"
                        value="pdf" checked /><br /> <label><span>csv</span></label>
                    <input type="radio" name="reportType" value="csv" />
                </div>
        ...
        <div class="hideable-form number-courses-in-plan-report" style="display:none">
            ...
            <form action="/ssp/api/1/report/map/numbercourses" method="get"
                ...
                <div class="ea-input">
                    <select  class="input-subject-abbreviation-group" id="numberCoursesPlanSubjectAbbreviation"
                ...
                <!-- Formatted Course
                <div class="ea-input">
                    <select  class="input-formatted-course-group" id="numberCoursesPlanFormattedCourse"
                ...
                <!-- Term -->
                <div class="ea-input">
                    <select id="numberCoursesTermCodes"  name="termCode" class="input-term-group"></select>
                </div>
                <div class="ea-label">
                    <span>Term:</span>
                </div>
        ...
        <div class="hideable-form number-students-by-status-report" style="display:none">
            ...
            <form action="/ssp/api/1/report/map/numberstudentsbystatus" method="get"
                ...
                <!-- Subject Abbreviations -->
                <div class="ea-input">
                    <select  class="input-subject-abbreviation-group" id="numberStudentsByStatusSubjectAbbreviations"
                        name="subjectAbbreviation">
                        <option value="">${not_applicable}</option>
                    </select>
                </div>
        ...
        <div class="hideable-form journal-case-notes-by-student-report" style="display:none">
            ...
            <form action="/ssp/api/1/report/journalcasenotesbystudent" method="get"
                ...
                <!-- Special Service Groups -->
                <div class="ea-input">
                    <select  class="input-special-service-group" id="journalCaseNotesSpecialServiceGroupIds"
                        name="specialServiceGroupIds" multiple="multiple">
                        <option value="">${not_applicable}</option>
                    </select>
                </div>
                <div class="ea-label">
