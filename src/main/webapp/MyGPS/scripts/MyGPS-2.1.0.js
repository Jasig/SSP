...
(function() {
  ...
  (function($) {
    var TaskFilter;
    return namespace("mygps.enumeration", {
      TaskFilter: TaskFilter = (function() {

        TaskFilter.name = 'TaskFilter';
  ...
  (function($) {
    var ChallengeReferral;
    return namespace('mygps.model', {
      ChallengeReferral: ChallengeReferral = (function() {

        ChallengeReferral.name = 'ChallengeReferral';
  ...
  (function($) {
    ...
    return namespace('mygps.model', {
      SelfHelpGuide: SelfHelpGuide = (function() {
        ...
        SelfHelpGuide.name = 'SelfHelpGuide';
  ...
  (function($) {
    ...
    return namespace('mygps.model', {
      SelfHelpGuideContent: SelfHelpGuideContent = (function(_super) {
        ...
        SelfHelpGuideContent.name = 'SelfHelpGuideContent';
  ...
  (function($) {
    var SelfHelpGuideQuestion;
    return namespace('mygps.model', {
      SelfHelpGuideQuestion: SelfHelpGuideQuestion = (function() {

        SelfHelpGuideQuestion.name = 'SelfHelpGuideQuestion';
  ...
  (function($) {
    ...
    return namespace('mygps.model', {
      SelfHelpGuideResponse: SelfHelpGuideResponse = (function() {
        ...
        SelfHelpGuideResponse.name = 'SelfHelpGuideResponse';
  ...
  (function($) {
    var Session;
    return namespace('mygps.session', {
  ...
  (function($) {
    var AbstractService;
    return namespace('mygps.service', {
  ...
  (function($) {
    ...
    return namespace('mygps.service', {
      ChallengeService: ChallengeService = (function(_super) {
        ...
        ChallengeService.name = 'ChallengeService';
  ...
  (function($) {
    var AbstractSessionViewModel;
    return namespace('mygps.viewmodel', {
      AbstractSessionViewModel: AbstractSessionViewModel = (function() {

        AbstractSessionViewModel.name = 'AbstractSessionViewModel';
  ...
  (function($) {
    var ChallengeReferralSearchViewModel;
    return namespace('mygps.viewmodel', {
      ChallengeReferralSearchViewModel: ChallengeReferralSearchViewModel = (function(_super) {
        ...
        ChallengeReferralSearchViewModel.name = 'ChallengeReferralSearchViewModel';
  ...
  (function($) {
    ...
    return namespace('mygps.viewmodel', {
      HomeViewModel: HomeViewModel = (function(_super) {
        ...
        HomeViewModel.name = 'HomeViewModel';
  ...
  (function($) {
    ...
    return namespace('mygps.viewmodel', {
      LoginViewModel: LoginViewModel = (function() {
        ...
        LoginViewModel.name = 'LoginViewModel';
