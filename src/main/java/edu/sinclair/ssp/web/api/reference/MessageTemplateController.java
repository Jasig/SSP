...
public class MessageTemplateController extends
		RestController<MessageTemplateTO> {
	...
	private TransferObjectListFactory<MessageTemplateTO, MessageTemplate> listFactory = new TransferObjectListFactory<MessageTemplateTO, MessageTemplate>(
			MessageTemplateTO.class);
	...
	public @ResponseBody
	MessageTemplateTO get(@PathVariable UUID id) throws Exception {
		MessageTemplate model = service.get(id);
		if (model != null) {
			return new MessageTemplateTO(model);
		} else {
			return null;
		}
	}
	...
	public @ResponseBody
	MessageTemplateTO create(@Valid @RequestBody MessageTemplateTO obj)
			throws Exception {
		if (obj.getId() != null) {
			throw new ValidationException(
					"You submitted a messageTemplate with an id to the create method.  Did you mean to save?");
		}

		MessageTemplate model = obj.asModel();

		if (null != model) {
			MessageTemplate createdModel = service.create(model);
			if (null != createdModel) {
				return new MessageTemplateTO(createdModel);
			}
		}
		return null;
	}
	...
	public @ResponseBody
	MessageTemplateTO save(@PathVariable UUID id,
			@Valid @RequestBody MessageTemplateTO obj)
			throws Exception {
		if (id == null) {
			throw new ValidationException(
					"You submitted a messageTemplate without an id to the save method.  Did you mean to create?");
		}

		MessageTemplate model = obj.asModel();
		model.setId(id);

		MessageTemplate savedMessageTemplate = service.save(model);
		if (null != savedMessageTemplate) {
			return new MessageTemplateTO(savedMessageTemplate);
		}
		return null;
	}
