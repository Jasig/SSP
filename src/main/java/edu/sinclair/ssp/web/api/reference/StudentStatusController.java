...
public class StudentStatusController extends RestController<StudentStatusTO> {
	...
	private TransferObjectListFactory<StudentStatusTO, StudentStatus> listFactory = new TransferObjectListFactory<StudentStatusTO, StudentStatus>(
			StudentStatusTO.class);

	@Override
	@RequestMapping(value = "/", method = RequestMethod.GET)
	public @ResponseBody
	List<StudentStatusTO> getAll(@RequestParam(required = false) ObjectStatus status)
			throws Exception {
		if (status == null) {
	...
	public @ResponseBody
	StudentStatusTO get(@PathVariable UUID id) throws Exception {
	...
	public @ResponseBody
	StudentStatusTO create(@Valid @RequestBody StudentStatusTO obj) throws Exception {
		if (obj.getId() != null) {
			throw new ValidationException(
					"You submitted a studentStatus with an id to the create method.  Did you mean to save?");
		}
	...
	public @ResponseBody
	StudentStatusTO save(@PathVariable UUID id, @Valid @RequestBody StudentStatusTO obj)
			throws Exception {
		if (id == null) {
			throw new ValidationException(
