...
public class ChallengeTOFactory implements IChallengeTOFactory { //implements TransferObjectFactory<ChallengeTO, Challenge> {
	...
	public ChallengeTO toTO(Challenge from) {
		ChallengeTO to = new ChallengeTO(from.getId(), from.getName(), from.getDescription());
