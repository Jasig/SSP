...
implements AuditableCrudDao<Citizenship> {
	...
	public List<Citizenship> selectAffirmativeBySelfHelpGuideResponseId(
	...
	@SuppressWarnings("unchecked")
	public List<Citizenship> searchByQuery(String query) {
		query = "%" + query.toUpperCase() + "%";

		return this.sessionFactory.getCurrentSession()
				.createQuery("select distinct c " +
						"from Citizenship c " +
						"inner join c.citizenshipCitizenshipReferrals ccr " +
						...
						"and exists " +
						"(from CitizenshipReferral " +
						"where id = ccr.citizenshipReferral.id " +
	...
	@SuppressWarnings("unchecked")
	public List<Citizenship> selectForStudentIntake() {
		return this.sessionFactory.getCurrentSession()
				.createQuery("from Citizenship " +
