 ...
 */
@Repository
public class ConfidentialityLevelDao implements
	...
	public List<ConfidentialityLevel> getAll(ObjectStatus status,
		...
		Criteria query = sessionFactory.getCurrentSession()
				.createCriteria(ConfidentialityLevel.class)
	...
	@Override
	public ConfidentialityLevel get(UUID id) {
		return (ConfidentialityLevel) sessionFactory.getCurrentSession().get(
				ConfidentialityLevel.class, id);
	}

	@Override
	public ConfidentialityLevel save(ConfidentialityLevel obj) {
		if (obj.getId() != null) {
			obj = (ConfidentialityLevel) sessionFactory.getCurrentSession()
					.merge(obj);
		} else {
	...
	@Override
	public void delete(ConfidentialityLevel obj) {
