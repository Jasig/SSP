...
implements AuditableCrudDao<FundingSource> {
	...
	public List<FundingSource> selectAffirmativeBySelfHelpGuideResponseId(
	...
	@SuppressWarnings("unchecked")
	public List<FundingSource> searchByQuery(String query) {
		query = "%" + query.toUpperCase() + "%";

		return this.sessionFactory.getCurrentSession()
				.createQuery("select distinct c " +
						"from FundingSource c " +
						"inner join c.fundingSourceFundingSourceReferrals ccr " +
						...
						"and exists " +
						"(from FundingSourceReferral " +
						"where id = ccr.fundingSourceReferral.id " +
	...
	@SuppressWarnings("unchecked")
	public List<FundingSource> selectForStudentIntake() {
		return this.sessionFactory.getCurrentSession()
				.createQuery("from FundingSource " +
