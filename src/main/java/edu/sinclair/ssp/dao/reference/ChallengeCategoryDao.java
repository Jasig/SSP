 ...
 */
@Repository
public class ChallengeCategoryDao implements
	...
	public List<ChallengeCategory> getAll(ObjectStatus status, int firstResult,
		...
		Criteria query = sessionFactory.getCurrentSession()
				.createCriteria(ChallengeCategory.class)
	...
	@Override
	public ChallengeCategory get(UUID id) {
		return (ChallengeCategory) sessionFactory.getCurrentSession().get(
				ChallengeCategory.class, id);
	}

	@Override
	public ChallengeCategory save(ChallengeCategory obj) {
		if (obj.getId() != null) {
			obj = (ChallengeCategory) sessionFactory.getCurrentSession().merge(
					obj);
		} else {
	...
	@Override
	public void delete(ChallengeCategory obj) {
