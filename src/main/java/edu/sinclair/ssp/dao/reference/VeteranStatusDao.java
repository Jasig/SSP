...
implements AuditableCrudDao<VeteranStatus> {
	...
	public List<VeteranStatus> selectAffirmativeBySelfHelpGuideResponseId(
	...
	@SuppressWarnings("unchecked")
	public List<VeteranStatus> searchByQuery(String query) {
		query = "%" + query.toUpperCase() + "%";

		return this.sessionFactory.getCurrentSession()
				.createQuery("select distinct c " +
						"from VeteranStatus c " +
						"inner join c.veteranStatusVeteranStatusReferrals ccr " +
						...
						"and exists " +
						"(from VeteranStatusReferral " +
						"where id = ccr.veteranStatusReferral.id " +
	...
	@SuppressWarnings("unchecked")
	public List<VeteranStatus> selectForStudentIntake() {
		return this.sessionFactory.getCurrentSession()
				.createQuery("from VeteranStatus " +
