...
public class ScheduledTaskWrapperServiceImpl
	 ...
	 * @return
	 */
	protected <T> CallableExecutor<T> newTaskWithContextExecutor(T returnType) {
	...
	public void sendMessages() {
		messageService.sendQueuedMessages(newTaskWithContextExecutor(messageService.getSendQueuedMessagesBatchExecReturnType()));
	}
	...
	public void syncExternalPersons() {
		externalPersonSyncTask.exec(newTaskWithContextExecutor(externalPersonSyncTask.getBatchExecReturnType()));
	}
