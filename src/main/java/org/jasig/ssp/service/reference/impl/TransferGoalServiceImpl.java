...
@Service
@Transactional
public class TransferGoalServiceImpl extends
		AbstractReferenceService<TransferGoal>
		implements TransferGoalService {

	@Autowired
	transient private TransferGoalDao dao;
	 ...
	 */
	protected void setDao(final TransferGoalDao dao) {
		this.dao = dao;
	}
}