...
AbstractAuditableCrudService<Job>
		implements JobService {

	@Autowired
	transient private JobDao dao;

	protected void setDao(final JobDao dao) {
		this.dao = dao;
	}
	...
	@Override
	public Job save(Job obj) throws ObjectNotFoundException,
			ValidationException {
		return dao.save(obj);
	}
	...
	public List<Job> getNextQueuedJobsForExecution(int i,String processId) {
		return dao.getNextQueuedJobsForExecution(i,processId);
	}
}
