...
public class MapTemplateTag
	...
	public MapTemplateTag(@NotNull final UUID id) {
		super(id);
	}
	 ...
	 */
	public MapTemplateTag(@NotNull final UUID id, @NotNull final String name,
	...
	public MapTemplateTag clone() {
		MapTemplateTag clone = new MapTemplateTag();
