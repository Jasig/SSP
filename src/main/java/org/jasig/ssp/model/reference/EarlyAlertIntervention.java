 ...
 */
 /*
 * IRSC CUSTOMIZATIONS
 * 06/12/2014 - Jonathan Hart IRSC TAPS 20140039 - Created EarlyAlertIntervention.java
 */
...
/**
 * EarlyAlertIntervention reference object.
 * 
 * Based on EarlyAlertSuggestion by @author jon.adams
 */
@Entity
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
public class EarlyAlertIntervention
	...
	public EarlyAlertIntervention(@NotNull final UUID id) {
		super(id);
	}
