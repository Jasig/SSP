...
public enum NotificationCategory implements CodeAndProperty {

	E("Email"), N("Notification"), S("System"), SU("Student Update");

	private String title;

	private NotificationCategory(final String title) {
		this.title = title;
	}
