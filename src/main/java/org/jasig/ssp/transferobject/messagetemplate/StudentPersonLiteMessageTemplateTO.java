...
public class StudentPersonLiteMessageTemplateTO extends CoachPersonLiteTO {
	...
	public StudentPersonLiteMessageTemplateTO(Person person) {
		super(person);
	...
	public boolean equalsAllFields(Object o) {
		...
		StudentPersonLiteMessageTemplateTO that = (StudentPersonLiteMessageTemplateTO) o;
		...
		if (currentProgramStatusName != null ? !currentProgramStatusName.equals(that.currentProgramStatusName) : that.currentProgramStatusName != null)
			return false;
