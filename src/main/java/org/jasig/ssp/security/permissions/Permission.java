...
public class Permission { // NOPMD enum won't work for these values in
	...
	//Template Admin Role
	public static final String MAP_PUBLIC_TEMPLATE_WRITE = ROLE_PREFIX + "MAP_PUBLIC_TEMPLATE_WRITE";
	...
	public static final String SECURITY_REFERENCE_TEMPLATE_WRITE = HAS_ANY_ROLE + REFERENCE_WRITE + HAS_ANY_ROLE_SEPARATOR + REFERENCE_MAP_WRITE + HAS_ANY_ROLE_SEPARATOR + MAP_PUBLIC_TEMPLATE_WRITE + END;
