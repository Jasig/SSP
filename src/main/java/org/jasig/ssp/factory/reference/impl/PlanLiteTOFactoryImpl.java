...
public class PlanLiteTOFactoryImpl extends AbstractAuditableTOFactory<PlanLiteTO, Plan>
		implements PlanLiteTOFactory {

	public PlanLiteTOFactoryImpl() {
		super(PlanLiteTO.class, Plan.class);
	}
	...
	@Override
	public Plan from(PlanLiteTO tObject) throws ObjectNotFoundException {
