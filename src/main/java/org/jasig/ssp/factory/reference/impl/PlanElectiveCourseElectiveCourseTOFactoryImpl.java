...
import org.jasig.ssp.dao.PlanElectiveCourseElectiveDao;
...
public class PlanElectiveCourseElectiveCourseTOFactoryImpl extends
		AbstractAuditableTOFactory<PlanElectiveCourseElectiveTO, PlanElectiveCourseElective>
		implements PlanElectiveCourseElectiveCourseTOFactory {

	public PlanElectiveCourseElectiveCourseTOFactoryImpl() {
		super(PlanElectiveCourseElectiveTO.class, PlanElectiveCourseElective.class);
	}

	@Autowired
	private transient PlanElectiveCourseElectiveDao dao;

	@Override
	protected PlanElectiveCourseElectiveDao getDao() {
		return dao;
	}
