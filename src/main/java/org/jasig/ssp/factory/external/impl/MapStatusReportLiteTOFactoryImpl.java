...
public class MapStatusReportLiteTOFactoryImpl
		extends
		AbstractExternalDataTOFactory<MapStatusReportLiteTO, MapStatusReport>
		implements MapStatusReportLiteTOFactory {



	public MapStatusReportLiteTOFactoryImpl() {
		super(MapStatusReportLiteTO.class, MapStatusReport.class);
	}
	...
	@Override
	public MapStatusReport from(MapStatusReportLiteTO tObject)
