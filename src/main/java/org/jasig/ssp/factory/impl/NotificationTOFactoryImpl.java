...
public class NotificationTOFactoryImpl extends AbstractAuditableTOFactory<NotificationTO, NotificationRecipient>
		implements NotificationTOFactory {

	public NotificationTOFactoryImpl() {
		super(NotificationTO.class, NotificationRecipient.class);
	}
	...
	@Override
	public NotificationRecipient from(final NotificationTO tObject) throws ObjectNotFoundException {
