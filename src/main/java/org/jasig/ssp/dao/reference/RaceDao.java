...
/**
 * Data access class for the Race reference entity.
 */
@Repository
public class RaceDao extends AbstractReferenceAuditableCrudDao<Race>
		implements AuditableCrudDao<Race> {
	...
	@Override
	public PagingWrapper<Race> getAll(final SortingAndPaging sAndP) {
