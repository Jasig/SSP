...
public class EarlyAlertReferralController
	...
	public @ResponseBody EarlyAlertReferralTO create(@Valid @RequestBody final EarlyAlertReferralTO obj)
	...
	public @ResponseBody EarlyAlertReferralTO save(@PathVariable final UUID id, @Valid @RequestBody final EarlyAlertReferralTO obj)
