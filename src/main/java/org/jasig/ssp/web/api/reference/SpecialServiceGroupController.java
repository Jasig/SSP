...
public class SpecialServiceGroupController
	...
	public @ResponseBody SpecialServiceGroupTO create(@Valid @RequestBody final SpecialServiceGroupTO obj)
	...
	public @ResponseBody SpecialServiceGroupTO save(@PathVariable final UUID id, @Valid @RequestBody final SpecialServiceGroupTO obj)
