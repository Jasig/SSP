...
@Controller
@RequestMapping("/1/reference/courseworkHours")
@PreAuthorize(Permission.SECURITY_REFERENCE_STUDENT_INTAKE_WRITE)
public class CourseworkHoursController
		extends
		AbstractAuditableReferenceController<CourseworkHours, CourseworkHoursTO> {

	@Autowired
	protected transient CourseworkHoursService service;

	@Override
	protected AuditableCrudService<CourseworkHours> getService() {
		return service;
	}

	@Autowired
	protected transient CourseworkHoursTOFactory factory;

	@Override
	protected TOFactory<CourseworkHoursTO, CourseworkHours> getFactory() {
		return factory;
	}

	protected CourseworkHoursController() {
		super(CourseworkHours.class, CourseworkHoursTO.class);
	}

	private static final Logger LOGGER = LoggerFactory
			.getLogger(CourseworkHoursController.class);
	...
	public @ResponseBody CourseworkHoursTO create(@Valid @RequestBody final CourseworkHoursTO obj)
	...
	public @ResponseBody CourseworkHoursTO save(@PathVariable final UUID id, @Valid @RequestBody final CourseworkHoursTO obj)
