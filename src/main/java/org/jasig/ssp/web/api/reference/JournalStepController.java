...
public class JournalStepController
	...
	public @ResponseBody JournalStepTO create(@Valid @RequestBody final JournalStepTO obj)
	...
	public @ResponseBody JournalStepTO save(@PathVariable final UUID id, @Valid @RequestBody final JournalStepTO obj)
