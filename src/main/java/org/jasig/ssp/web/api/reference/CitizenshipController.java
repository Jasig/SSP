...
public class CitizenshipController
	...
	public @ResponseBody CitizenshipTO create(@Valid @RequestBody final CitizenshipTO obj)
	...
	public @ResponseBody CitizenshipTO save(@PathVariable final UUID id, @Valid @RequestBody final CitizenshipTO obj)
