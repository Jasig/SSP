...
public class SapStatusController
	...
	public @ResponseBody SapStatusTO create(@Valid @RequestBody final SapStatusTO obj)
	...
	public @ResponseBody SapStatusTO save(@PathVariable final UUID id, @Valid @RequestBody final SapStatusTO obj)
