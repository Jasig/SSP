...
public class EthnicityController
	...
	public @ResponseBody EthnicityTO create(@Valid @RequestBody final EthnicityTO obj)
	...
	public @ResponseBody EthnicityTO save(@PathVariable final UUID id, @Valid @RequestBody final EthnicityTO obj)
