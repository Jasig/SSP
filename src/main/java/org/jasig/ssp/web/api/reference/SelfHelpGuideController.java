...
public class SelfHelpGuideController
	...
	public @ResponseBody SelfHelpGuideTO create(@Valid @RequestBody final SelfHelpGuideTO obj)
	...
	public @ResponseBody SelfHelpGuideTO save(@PathVariable final UUID id, @Valid @RequestBody final SelfHelpGuideTO obj)
