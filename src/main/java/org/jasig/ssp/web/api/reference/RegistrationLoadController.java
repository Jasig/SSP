...
public class RegistrationLoadController
	...
	public @ResponseBody RegistrationLoadTO create(@Valid @RequestBody final RegistrationLoadTO obj)
	...
	public @ResponseBody RegistrationLoadTO save(@PathVariable final UUID id, @Valid @RequestBody final RegistrationLoadTO obj)
