...
public class StudentTypeController
	...
	public @ResponseBody StudentTypeTO create(@Valid @RequestBody final StudentTypeTO obj)
	...
	public @ResponseBody StudentTypeTO save(@PathVariable final UUID id, @Valid @RequestBody final StudentTypeTO obj)
