...
public class DisabilityTypeController
	...
	public @ResponseBody DisabilityTypeTO create(@Valid @RequestBody final DisabilityTypeTO obj)
	...
	public @ResponseBody DisabilityTypeTO save(@PathVariable final UUID id, @Valid @RequestBody final DisabilityTypeTO obj)
