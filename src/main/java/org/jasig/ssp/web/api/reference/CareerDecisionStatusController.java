...
@Controller
@RequestMapping("/1/reference/careerstatus")
@PreAuthorize(Permission.SECURITY_REFERENCE_MAIN_TOOL_WRITE)
public class CareerDecisionStatusController
		extends
		AbstractAuditableReferenceController<CareerDecisionStatus, CareerDecisionStatusTO> {

	@Autowired
	protected transient CareerDecisionStatusService service;

	@Override
	protected AuditableCrudService<CareerDecisionStatus> getService() {
		return service;
	}

	@Autowired
	protected transient CareerDecisionStatusTOFactory factory;

	@Override
	protected TOFactory<CareerDecisionStatusTO, CareerDecisionStatus> getFactory() {
		return factory;
	}

	protected CareerDecisionStatusController () {
		super(CareerDecisionStatus.class, CareerDecisionStatusTO.class);
	}

	private static final Logger LOGGER = LoggerFactory
			.getLogger(CareerDecisionStatusController.class);
	...
	public @ResponseBody CareerDecisionStatusTO create(@Valid @RequestBody final CareerDecisionStatusTO obj)
	...
	public @ResponseBody CareerDecisionStatusTO save(@PathVariable final UUID id, @Valid @RequestBody final CareerDecisionStatusTO obj)
