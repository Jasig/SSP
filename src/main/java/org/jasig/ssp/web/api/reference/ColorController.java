...
public class ColorController
	...
	@Autowired
	protected transient ColorService service;

	@Override
	protected AuditableCrudService<Color> getService() {
		return service;
	}

	@Autowired
	protected transient ColorTOFactory factory;

	@Override
	protected TOFactory<ColorTO, Color> getFactory() {
		return factory;
	}

	protected ColorController() {
		super(Color.class, ColorTO.class);
	}
