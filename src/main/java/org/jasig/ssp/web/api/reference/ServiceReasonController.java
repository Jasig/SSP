...
public class ServiceReasonController
	...
	public @ResponseBody ServiceReasonTO create(@Valid @RequestBody final ServiceReasonTO obj)
	...
	public @ResponseBody ServiceReasonTO save(@PathVariable final UUID id, @Valid @RequestBody final ServiceReasonTO obj)
