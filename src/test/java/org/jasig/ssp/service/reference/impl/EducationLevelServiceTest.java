...
public class EducationLevelServiceTest {
	...
	public void testGetAll() {
		final List<EducationLevel> daoAll = new ArrayList<EducationLevel>();
		daoAll.add(new EducationLevel());

		expect(dao.getAll(isA(SortingAndPaging.class))).andReturn(
				new PagingWrapper<EducationLevel>(daoAll));

		replay(dao);

		final Collection<EducationLevel> all = service.getAll(
	...
	public void testGet() throws ObjectNotFoundException {
		...
		final EducationLevel daoOne = new EducationLevel(id);
	...
	public void testDelete() throws ObjectNotFoundException {
		...
		expect(dao.get(id)).andThrow(
				new ObjectNotFoundException(id, "EducationLevel"));
