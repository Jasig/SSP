...
/**
 * JUnit test class for {@link EarlyAlertServiceImpl} sendAllEarlyAlertReminderNotificationsTest method when config 
 * specifies that only coaches should receive the reminders, unless a student has no coach, in which case the EAC 
 * should receive the reminder.
 */
public class SendAllEarlyAlertReminderNotificationsToCoachOrEacIfNoCoachTest 
	...
	private void setUpConfig() {
		...
		given(this.config.includeEarlyAlertCoordinatorAsRecipientOnlyIfStudentHasNoCoach()).willReturn(true);
	}
