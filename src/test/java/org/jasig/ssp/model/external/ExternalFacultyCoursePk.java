 ...
 * {@link WriteableExternalFacultyCourse} (even if the underlying db does not
 * actually declare a PK for the corresponding table).
 */
public class ExternalFacultyCoursePk implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ExternalFacultyCoursePk)) return false;

		ExternalFacultyCoursePk that = (ExternalFacultyCoursePk) o;
