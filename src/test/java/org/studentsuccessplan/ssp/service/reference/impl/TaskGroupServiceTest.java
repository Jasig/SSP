...
public class TaskGroupServiceTest {
	...
	public void setup() {
		...
		dao = createMock(TaskGroupDao.class);
	...
	public void testGetAll() {
		List<TaskGroup> daoAll = new ArrayList<TaskGroup>();
		daoAll.add(new TaskGroup());
		...
		List<TaskGroup> all = service.getAll(ObjectStatus.ACTIVE, null, null,
				null, null);
	...
	public void testGet() throws ObjectNotFoundException {
		...
		TaskGroup daoOne = new TaskGroup(id);
