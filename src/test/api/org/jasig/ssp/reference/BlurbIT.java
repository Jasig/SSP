...
public class BlurbIT extends AbstractReferenceTest {
    ...
    private static final String[] BLURB_ENTITY_TYPE_CODES;
    ...
    static {
        ...
        BLURB_UUIDS = new String[] {
                ...
                "1026cbd8-7a8a-499a-a404-7f3af488fa65", "64ef22e1-0cf3-44df-9ccb-993ab7548baa",
                "337d77c4-3689-4581-b924-6dc0dcdb1be1", "9b1182c7-9783-4be0-bc09-a30bf0d45f47",
                "247c1850-b368-4f29-8c8b-7b25efce8605", "7112e79a-0a61-413a-8948-8c4c19f2bb18",
                "06b4151e-8857-4e65-870c-36da50268ee7", "8ae3cabd-4401-4ecb-b0bb-f1096a21b48b",
                "bc816c86-04c8-4d7b-87a5-0a74ad3ea23a", "1a92f3e6-9364-4e6f-8388-aee95a3af55d",
                "f079a6e4-8867-4c6a-b84a-b8fa07d8696c", "08e22868-8f83-489b-865d-95000b7ec374",
                "343eede9-b777-4d63-84f7-c65c71eee052", "eb189389-3112-4214-85c2-c406c773d245",
                "5187c5cd-5c20-44c1-920e-00dea367b3b6", "9a24e721-b59b-4d40-8edd-c522ac29f37a",
                "7b1d2b79-4f09-4338-944e-893f4f3cdeb7", "e45e465e-efde-4193-93c6-59996818d360",
                "baf298c9-5ddb-4c67-8957-c7e7445d2f08", "dabfee4c-f975-4c89-a749-1ff467da9884",
                "fd6dc9c9-219a-4634-9ee7-c5fcbbef6b8e", "2be74b03-8cf8-4410-a75b-20d8d4304cca",
                ...
                "cb3a7e29-4303-4a7a-87b5-fe9a10027e45", "ed71bc25-3190-4fd4-a68c-de14fcd264dc",
                "7b300c10-f858-4271-bfdd-1d271da358dd", "703b31a6-2d23-49cd-bbbc-a867920c2635",
                "ce66754b-869a-4a21-9e45-e414544cde0b", "e79a610e-6d61-4879-b3d3-b0a1d52495b5",
                "e43ec7f7-1a8a-422d-beca-bb3aad14cb36", "0893976d-f7bd-41ed-8ea1-0d1089ff0ed8",
                "002d9807-8986-4db7-bbfb-f547381a8ff0", "13d9e636-6a50-4a43-9de0-e9f50307c693",
                "4133e249-f43d-4cf2-ab3b-9855f0c04aa6", "ec3ce67d-b149-466f-a2fe-cc9b176fc321",
                "e591579e-27cf-49fe-9294-00130fe0f16d", "5c611b41-64bf-4c81-ae51-0687ddf0fcb0",
        ...
        BLURB_NAMES = new String[] {
                ...
                "Intake Alternate In Use Label", "Intake Cell Phone Label", "Intake City Label",
                "Intake Country Label", "Intake First Name Label", "Intake Home Phone Label", "Intake Last Name Label",
                "Intake Middle Name Label", "Intake Non Local Label", "Intake School Email Label", "Intake State Label",
                "Intake Birth Date Label", "Intake Tab 1 Label", "Intake Work Phone Label", "Intake Zip Code Label",
                "Intake Tab 2 Label", "Intake Childcare Arrangements Label", "Intake Childcare Needed Label",
                "Intake Children Ages Label", "Intake Citizenship Label", "Intake Country of Citizenship Label",
                "Intake Employed Label", "Intake Ethnicity Label", "Intake Gender Label", "Intake Marital Status Label",
                "Intake Military Affiliation Label", "Intake Number of Children Label",
                "Intake Place of Employment Label", "Intake Primary Caregiver Label", "Intake Race Label",
                ...
                "Please Explain Label", "High School Attended Label", "Last Year Attended Label",
                "Year Graduated Label", "Year of GED Label", "Intake Tab 5 Label", "Intake Additional Info Label",
                "Intake Anticipated Graduation Date Label", "Bachelor's Degree Major Label",
                "Intake Confident Ability Label", "Intake Decided Occupation Label",
                ...
                "Intake Challenges Question Label"
        };

        BLURB_VALUES = new String[] {
                "Address Line 1", "Address Line 2", "School Email", "In Use", "Cell Phone", "City", "Country",
                "First Name", "Home Phone", "Last Name", "First Name", "Non Local", "School Email", "State",
                "Birth Date", "Person", "Work Phone", "Zip Code", "Demographics",
                "If yes, what are your childcare arrangements?", "Childcare Needed?",
                "Ages? Separate each age with a comma. (1,5,12)", "Citizenship", "Country of Citizenship",
                "Are you Employed?", "Ethnicity", "Gender", "Marital Status", "Military Affiliation",
                "If You have Children, How Many?", "Place of Employment", "Are you a Primary Caregiver?", "Race",
                "Shift", "Total Hours worked weekly while attending school", "Veteran Status", "Wage", "EduPlan",
                "Check all that you have completed", "Have your parents obtained a college degree?",
                "Special needs or require special accomodation?", "Student Status",
                "What grade did you typically earn at your highest level of education?", "EduLevel",
                "Education level completed: Select all that apply", "Please Explain", "High School Attended",
                "Last Year Attended", "Year Graduated", "Year of GED", "EduGoal",
        ...
        BLURB_CODES = new String[] {
                "intake.tab1.label.address-1", "intake.tab1.label.address-2", "intake.tab1.label.alternate-email",
                "intake.tab1.label.alt-in-use", "intake.tab1.label.cell-phone", "intake.tab1.label.city",
                "intake.tab1.label.country", "intake.tab1.label.first-name", "intake.tab1.label.home-phone",
                "intake.tab1.label.last-name", "intake.tab1.label.middle-name", "intake.tab1.label.non-local",
                "intake.tab1.label.school-email", "intake.tab1.label.state", "intake.tab1.label.student-id",
                "intake.tab1.label.tab1", "intake.tab1.label.work-phone", "intake.tab1.label.zip", "intake.tab2.label",
                "intake.tab2.label.childcare-arrangements", "intake.tab2.label.childcare-needed",
                "intake.tab2.label.children-ages", "intake.tab2.label.citizenship",
                "intake.tab2.label.country-citizenship", "intake.tab2.label.employed", "intake.tab2.label.ethnicity",
                "intake.tab2.label.gender", "intake.tab2.label.marital-status",
                ...
                "intake.tab2.label.race", "intake.tab2.label.shift", "intake.tab2.label.total-hours-worked",
                "intake.tab2.label.veteran-status", "intake.tab2.label.wage", "intake.tab3.label",
                "intake.tab3.label.completed", "intake.tab3.label.parents-college", "intake.tab3.label.special-needs",
                "intake.tab3.label.student-status", "intake.tab3.label.typical-grade", "intake.tab4.label",
                "intake.tab4.label.edu-level", "intake.tab4.label.explain-credits",
                ...
                "intake.tab7.label.challenges-question"
        };

        BLURB_ENTITY_TYPE_CODES = new String[] {
                "reference.address-1", "reference.address-2", "reference.alternate-email", "reference.alt-in-use",
                "reference.cell-phone", "reference.city", "reference.country", "reference.first-name",
                "reference.home-phone", "reference.last-name", "reference.middle-name", "reference.non-local",
                "reference.school-email", "reference.state", "reference.birth-date", "reference.tab1",
                "reference.work-phone", "reference.zip", "reference.tab2", "reference.childcare-arrangements",
                "reference.childcare-needed", "reference.children-ages", "reference.citizenship",
                "reference.country-citizenship", "reference.employed", "reference.ethnicity", "reference.gender",
                "reference.marital-status", "reference.military-affiliation", "reference.number-children",
                "reference.place-of-employment", "reference.primary-caregiver", "reference.race", "reference.shift",
                "reference.total-hours-worked", "reference.veteran-status", "reference.wage", "reference.tab3",
                "reference.completed", "reference.parents-college", "reference.special-needs",
                "reference.student-status", "reference.typical-grade", "reference.tab4", "reference.edu-level",
                "reference.explain-credits", "reference.highschool-attended", "reference.last-year-attended",
                "reference.year-graduated", "reference.year-of-ged", "reference.tab5", "reference.additional-info",
                "reference.anticipated-graduation", "reference.bachelor-major", "reference.confident-ability",
                "reference.decided-occupation", "reference.goal", "reference.hours-coursework",
                "reference.military-branch", "reference.other-funding", "reference.other-goal",
                "reference.planned-major", "reference.planned-occupation", "reference.registration-load",
                "reference.sure-major", "reference.sure-occupation", "reference.tab6", "reference.funding-question",
                "reference.other-challenges", "reference.other-funding", "reference.tab7",
                "reference.challenges-question"
        };

        BLURB_DESCRIPTIONS = new String[] {
                "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "Person tab label", "", "",
                "Demographics tab label", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                "EduPlan tab label", "", "", "", "", "", "EduLevel tab label", "", "", "", "", "", "",
                "EduGoal tab label", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""
        };
        ...
        for ( int index = 0; index < BLURB_UUIDS.length; index++ ) {
            ...
            temp.put("entityTypeCode", BLURB_ENTITY_TYPE_CODES[index]);
