...
public class PermissionIT extends AbstractReferenceTest {
    ...
    static {
        ...
        PERMISSION_NAMES = new String[] {
                ...
                "PERSON_EARLY_ALERT_RESPONSE_DELETE","PERSON_FILTERED_READ","PERSON_FILTERED_WRITE","PERSON_GOAL_READ",
                "PERSON_GOAL_WRITE","PERSON_GOAL_DELETE",
                ...
                "PERSON_LEGACY_REMARK_WRITE","PERSON_INSTRUCTION_READ","PERSON_SUCCESS_INDICATOR_READ","REPORT_READ",
                "REFERENCE_READ","REFERENCE_WRITE","SELF_HELP_GUIDE_ADMIN_READ","SELF_HELP_GUIDE_ADMIN_WRITE",
                "SELF_HELP_GUIDE_ADMIN_DELETE","MY_GPS_TOOL","STUDENT_INTAKE_READ","STUDENT_INTAKE_WRITE",
                "API_KEY_READ","API_KEY_WRITE","BULK_EMAIL_STUDENT","BULK_PROGRAM_STATUS","BULK_SEARCH_EXPORT",
        ...
        AUTHORITY_NAMES = new String[] {
                ...
                "ROLE_PERSON_FILTERED_READ","ROLE_PERSON_FILTERED_WRITE",
                ...
                "ROLE_PERSON_SUCCESS_INDICATOR_READ",
                ...
                "ROLE_BULK_EMAIL_STUDENT","ROLE_BULK_PROGRAM_STATUS","ROLE_BULK_SEARCH_EXPORT",
                "ROLE_BULK_WATCHLIST_WRITE"
        };
